...
public class JwtUtil {
    ...
    // 토큰 만료시간
    private final long TOKEN_TIME = 60 * 60 * 1000L; // 1000ms * 60sec * 60min

    //https://www.base64encode.org/ : base64 en/decode 가능한 사이트
